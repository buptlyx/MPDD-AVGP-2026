...
EXPERIMENT_NAME="${EXPERIMENT_NAME:-track2_young_tuned_avp_${AUDIO_FEATURE}_${VIDEO_FEATURE}_binary_kappa_v1}"
...
echo "[Track2][A-V+P][binary] seed=${SEED} target_t=${TARGET_T}"
cd "$PROJECT_ROOT"
