...
EXPERIMENT_NAME="${EXPERIMENT_NAME:-track1_elder_tuned_avp_${AUDIO_FEATURE}_${VIDEO_FEATURE}_ternary_kappa_v1}"
...
echo "[Track1][A-V+P][ternary] seed=${SEED} target_t=${TARGET_T}"
cd "$PROJECT_ROOT"
